<template>
    <div>
        <div class="flex-1 p-2 sm:p-6 px-1 justify-between flex flex-col h-screen">
            <div
            ...
            <div
                id="messages"
                class="flex flex-col space-y-4 p-3 px-1 overflow-y-auto scrollbar-thumb-blue scrollbar-thumb-rounded scrollbar-track-blue-lighter scrollbar-w-2 scrolling-touch"
            >
                <div
                ...
                >
                    ...
                    >
                        <div>
                            ...
                            <div class="text-xs p-1 float-left">
...
export default {
    mounted() {
        ...
        window.Echo.channel("notification-event." + this.getNotificationId).listen(
            "NotificationEvent",
            (e) => {
                // console.log('abc');
                this.getComments();
