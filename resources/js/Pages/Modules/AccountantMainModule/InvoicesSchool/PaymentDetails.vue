...
export default {
    ...
    computed: {
        ...
        getActivePayment() {
            this.classType =
                this.$store.getters["AccountantInvoiceModule/getActivePayment"];
            this.payType =
                this.$store.getters["AccountantInvoiceModule/getActivePayment"];
            return this.$store.getters[
                "AccountantInvoiceModule/getActivePayment"
            ];
        },
    ...
    methods: {
        ...
        setActivePayment(payType) {
            ...
            this.$store.dispatch(
                "AccountantInvoiceModule/setActivePayment",
                payType
            );
        },
        ...
        getStudents() {
            axios
                .post(this.getMainUrl + "accountant/getStudentPayments", {
