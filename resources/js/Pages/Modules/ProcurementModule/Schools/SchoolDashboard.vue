                        ...
                        <div class="card bg-pattern py-0 my-0">
                            <div class="card-body shadow">
                                <div class="row">
                                    <div class="col-6">
                                        <div
                                            class="avatar-sm bg-success rounded"
                                        >
                                            <i
                        ...
                        <div class="card bg-pattern py-0 my-0">
                            <div class="card-body shadow">
                                <div class="row">
                                    <div class="col-6">
                                        <div
                                            class="avatar-sm bg-primary rounded"
                                        >
                                            <i
...
// import Schools from "./Schools/Schools.vue";
export default {
    components: {
        PieChart3D,
        GoogleDonut,
    ...
    methods: {
        ...
        //     axios
        //         .post("http://127.0.0.1:8000/api/procurement/getDashboardData")
        //         .then((response) => {
