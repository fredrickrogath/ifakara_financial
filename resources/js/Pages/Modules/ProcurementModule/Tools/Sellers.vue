    ...
    <div>
        ...
        <div v-else>
            ...
            <v-card-title class="px-0 pt-0 pb-1">
                ...
                <v-icon type="button" class="ml-4 px-1 mt-3 mr-0 py-1" size="22" @click="setAddSeller()">
                    mdi-pen-plus
                </v-icon>
            </v-card-title>
            ...
            <v-data-table :headers="headers" :items="tools" item-key="name" :search="search" class="elevation-1">
        ...
        ">
                                ...
                                <span class="text-gray-600 italic font-semibold" v-else-if="header.value == 'id'">{{
                                    item[header.value] }}</span>

                                <span class="text-gray-600 italic font-semibold" v-else-if="header.value == 'name'">{{
                                    item[header.value] }}</span>

                                <span class="text-gray-600 italic font-semibold" v-else-if="header.value == 'location'">{{
                                    item[header.value] }}</span>

                                <span class="text-gray-600 italic font-semibold" v-else-if="header.value == 'email'">{{
                                    item[header.value] }}</span>

                                <span class="text-gray-600 italic font-semibold" v-else-if="header.value == 'mobile'">{{
                                    item[header.value] }}</span>
                                ...
                                <v-edit-dialog v-else :return-value.sync="item[header.value]" @save="
                                    ...
                                    <span class="text-gray-600 italic font-semibold" :class="item[header.value] == null &&
