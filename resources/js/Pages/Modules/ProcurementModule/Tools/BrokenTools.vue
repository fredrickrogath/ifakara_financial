    ...
    <div>
        ...
        <div v-else>
            ...
            <v-card-title class="px-0 pt-0 pb-1">
                    <div class="pl-2 pt-1 text-sm uppercase">Broken Tools</div>
                    <v-spacer></v-spacer>
...
export default {
    ...
    mounted() {
        ...
        window.Echo.channel("broken-tools-event").listen(
            "Procurement\\BrokenToolsEvent",
            (e) => {
                this.getTools();
                this.getBrokenTools();
            }
    ...
    methods: {
        ...
        getBrokenTools() {
            axios.get("/procurement/getBrokenTools").then((response) => {
                this.brokenTools = response.data.data;
                this.showLoader = false;
