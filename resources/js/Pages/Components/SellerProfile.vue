<template>
    ...
    <!-- <div class='flex items-center justify-center min-h-screen'> -->
        <div class="relative w-full mt-0 px-2 group max-w-md min-w-0 mx-auto break-words bg-white border shadow-2xl dark:bg-gray-800 dark:border-gray-700 md:max-w-sm rounded-xl">
            <div class="pb-6 -mt-5">
        ...
        <div class="mt-3 text-center">
            <h3 class="mb-1 text-2xl font-bold leading-normal text-gray-700 dark:text-gray-300"> {{ seller.name }} </h3>
            <div class="flex flex-row justify-center w-full mx-auto space-x-2 text-center">
                ...
                <div class="text-sm font-bold tracking-wide text-gray-600 dark:text-gray-300 font-mono"> {{ seller.location }} </div>

                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-gray-400" viewBox="0 0 20 20" fill="currentColor"><title>Mobile</title><path d="M17,19H7V5H17M17,1H7C5.89,1 5,1.89 5,3V21A2,2 0 0,0 7,23H17A2,2 0 0,0 19,21V3C19,1.89 18.1,1 17,1Z" /></svg>

                <div class="text-sm font-bold tracking-wide text-gray-600 dark:text-gray-300 font-mono"> {{ seller.location }} </div>
            </div>

            <div class="flex flex-row justify-center pt-1 w-full mx-auto space-x-2 text-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-gray-400" viewBox="0 0 20 20" fill="currentColor"><title>email</title><path d="M20,8L12,13L4,8V6L12,11L20,6M20,4H4C2.89,4 2,4.89 2,6V18A2,2 0 0,0 4,20H20A2,2 0 0,0 22,18V6C22,4.89 21.1,4 20,4Z" /></svg>
                <!-- /typography/_h3.antlers.html -->
                <div class="text-sm font-bold tracking-wide text-gray-600 dark:text-gray-300 font-mono"> {{ seller.email }} </div>

                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-gray-400" viewBox="0 0 20 20" fill="currentColor"><title>pdf file</title><path d="M6,2A2,2 0 0,0 4,4V20A2,2 0 0,0 6,22H18A2,2 0 0,0 20,20V8L14,2H6M6,4H13V9H18V20H6V4M8,12V14H16V12H8M8,16V18H13V16H8Z" /></svg>

                <a :href="storagePath + seller.path" class="text-sm font-bold tracking-wide text-gray-600 dark:text-gray-300 font-mono"> Description</a>
            </div>
        ...
        <div class="pt-2 mx-6 mt-2 text-center border-t border-gray-200 dark:border-gray-700/50">
            <div class="flex flex-wrap justify-center">
                <div class="w-full px-6">
                    <p class="font-light leading-relaxed text-gray-600 dark:text-gray-400">
                        {{ seller.description }}
                    </p>
                </div>
            </div>
